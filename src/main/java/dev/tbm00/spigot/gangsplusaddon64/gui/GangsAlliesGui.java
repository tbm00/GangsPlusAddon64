...
public class GangsAlliesGui {
    ...
    public GangsAlliesGui(GangsPlusAddon64 javaPlugin, List<Gang> gangs, Player player, int sortIndex) {
        this.sender = player;
    ...
    private void fillGangs() {
        ...
        for (Gang gang : gangMap) {
            ...
            /*define item button's lore, name, flags, etc*/
                ...
                String ownerName = GangUtils.getGangOwnerName(gang);
